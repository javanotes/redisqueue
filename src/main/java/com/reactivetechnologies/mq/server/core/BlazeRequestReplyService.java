...
import com.reactivetechnologies.mq.server.reqres.RequestReplyReceiver;
/**
 * Synchronous operations involving a request and reply queue.
 * @author esutdal
 *
 */
public class BlazeRequestReplyService implements RequestReplyAble {
	/**
	 * New instance, passing arguments.
	 * @param callback
	 * @param qService
	 */
	public BlazeRequestReplyService(RequestReplyReceiver callback, QueueService qService) {
		super();
